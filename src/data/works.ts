...
export const works: Work[] = [
  // 1. Y-Tag
  {
    ...
    desc: {
      overview: "「テック×感性」を掲げるライフスタイルブランド「Y-Tag」のEC刷新。リブランディングに伴い、「余白を、持ち歩く。」という情緒的価値をデジタル上で体現するため、デザインから構築までを一貫して担当。ノイズレスなレイアウトでブランドの世界観を表現し、ギフトラッピングのLiquid独自実装で運用コストも削減しました。",
      summary: {
        background: {
          title: "スペック訴求から、情緒的価値へ",
