...
export default function Contact() {
  ...
  const inputClass = "w-full bg-transparent border border-[#D4D4D8] rounded-[6px] px-3 py-2.5 text-[12px] md:text-[14px] text-[#333] placeholder-[#A1A1AA] outline-none focus:border-[#333] focus:shadow-[0_0_0_3px_rgba(51,51,51,0.1)] transition-all duration-200 font-noto";
